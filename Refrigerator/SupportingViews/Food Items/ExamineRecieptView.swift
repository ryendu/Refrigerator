                    ...
                    ZStack{
                        VStack {
                            ...
                            .onAppear(perform: {//TODO: FIX THE DEFAULT STORAGE LOCATIONS
                                ...
                                if RemoteConfigManager.intValue(forkey: RCKeys.numberOfAdsNonHomeView.rawValue) >= 3 && self.possiblyDoSomething(withPercentAsDecimal: RemoteConfigManager.doubleValue(forkey: RCKeys.chanceOfPopups.rawValue)) && UserDefaults.standard.bool(forKey: "ExamineRecieptViewLoadedAd") == false && self.refrigeratorViewModel.isPremiumPurchased() == false{
